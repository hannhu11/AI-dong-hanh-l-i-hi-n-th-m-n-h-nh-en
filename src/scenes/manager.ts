...
export class ConfigManager {
    ...
    public loadSpriteSheet(sprite: ISpriteConfig): void {
        if (!this.load) {
            error("Loader manager is not set");
            return;
        }
    ...
    public getAnimationConfigPerSprite(sprite: ISpriteConfig): {
        key: string;
    ...
    public validatePetSprite(sprite: ISpriteConfig): boolean {
