...
import ScenariosTab from './ui/setting_tabs/ScenariosTab';
...
function SettingWindow() {
  ...
  const settingTabs: ISettingTabs[] = useMemo(() => ([
    ...
    },
    {
      ...
      description: "Tự động hóa workflow với AI thông minh - Tạo và thực thi các chuỗi hành động",
      Icon: <IconRocket size="1rem" />,
      label: "Kịch Bản AI",
      tab: ESettingTab.Scenarios,
    },
    {
      Component: Settings,
